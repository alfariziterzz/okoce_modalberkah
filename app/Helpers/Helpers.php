...
class Helpers
{
  ...
  public static function astatus(){
		return array(
          array('id'=>"",'value'=>'Menunggu Persetujuan','class'=>'warning'),
          array('id'=>1,'value'=>'Menunggu Persetujuan','class'=>'warning'),
            array('id'=>2,'value'=>'Disetujui','class'=>'success'),
            array('id'=>3,'value'=>'Ditolak','class'=>'danger')
        );
  }
  public static function  getStatus($id=null){
      $status_arr = self::astatus();
  ...
  public static function  getColorStatus($id=null){
    $status_arr = self::astatus();
    foreach($status_arr as $row){
        if($row['id']==$id){
            return $row['class'];
  ...
  public static function astatusLunas(){
		return array(
          array('id'=>"",'value'=>'Blm Lunas','class'=>'danger'),
          array('id'=>1,'value'=>'Lunas','class'=>'success'),
            array('id'=>2,'value'=>'Blm Lunas','class'=>'danger')
        );
  }
  public static function  getStatusLunas($id=null){
      $status_arr = self::astatusLunas();
      foreach($status_arr as $row){
          if($row['id']==$id){
              return $row['value'];
          }
  ...
  public static function  getColorStatusLunas($id=null){
    $status_arr = self::astatusLunas();
    foreach($status_arr as $row){
        if($row['id']==$id){
            return $row['class'];
