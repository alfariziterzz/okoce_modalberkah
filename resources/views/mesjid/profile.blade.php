  ...
  <div class="row">
    ...
    <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
      ...
      <ul class="nav nav-pills flex-column flex-md-row mb-4">
        <li class="nav-item">
          <a class="nav-link active" href="{{route('mst.mesjid.profile')}}"
            ><i class="ti ti-lock ti-xs me-1"></i>Account</a
          >
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{route('mst.mesjid.member')}}"
      ...
      <!-- Activity Timeline -->
      <div class="card mb-4">
        <h5 class="card-header">Request Peminjaman Blm Proses</h5>
        <div class="card-body card-datatable table-responsive">
          <table class="dt-multilingual table dataTable no-footer dtr-column" id="dttable">
...
<script>
  $table = $("#dttable").DataTable({
      ...
      ajax: {
          "url": "{{ route('mst.pinjaman.getdatablmproses',$dataMesjid->ref) }}",
          "data": function(d) {
