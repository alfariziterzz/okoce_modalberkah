...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">All User / Inaktif</h4>
...
<script>
      ...
      $.ajax({
        ...
        success:function(data){
            if(data.success){
              ...
              let optionValue = data.data.role_id;
              $("#role_id").val(optionValue).find("option[value=" + optionValue +"]").attr('selected', true);
  ...
  $table = $("#dttable_user").DataTable({
      ...
      ajax: {
          "url": "{{ route('user.getdata.inactive') }}",
          "data": function(d) {
